...
from image_module.codebook import load_codebook, K
from image_module.search import query_visual_words
from image_module.split import GRID
...
if __name__ == "__main__":
    ...
    sample = next((str(p) for p in Path("data/raw/images").glob("*.jpg")), None)
    if sample:
